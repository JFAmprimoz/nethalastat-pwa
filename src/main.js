...
// --- 1. Data Structure, Schema Definition & Instantiation ---
        ...
        // --- 4. Bottom-Sheet Flyout Drawer Toggle Logic ---
        ...
        // --- 5. Dropdown Selector Addition Logic ---
        ...
        function renderModal() {
            ...
            currentContainer.innerHTML = appData.rightStats.map((stat) => {
                if (stat.customizable) {
                    return `
                        <div class="modal-row">
                            <input type="text" class="modal-input-name" id="edit-right-${stat.id}-name" value="${stat.name}" />
                    ...
                    return `
                        <div class="modal-row">
                            <label class="modal-label">${stat.name}:</label>
                            <input type="number" class="modal-input-val" id="edit-right-${stat.id}-val" value="${stat.current}" />
                        </div>
                    `;
                }
